...
/**
 * Strings for component 'block_odsoaipmh', language 'pt'
 *
...
$string['pluginname'] = 'Metadados ECO';
...
$string['share_course_allow'] = "Extracao de metadados";
$string['share_course_allow_1'] = "Usar opcao por omissao";
$string['share_course_allow_2'] = "Permitir extracao de metadados";
$string['share_course_allow_3'] = "Impedir extracao de metadados";

$string['share_type'] = "Modulos inspecionados:";
$string['share_type_1'] = "Mesma configuracao do sistema";
$string['share_type_2'] = "Todos os modulos";
$string['share_type_3'] = "Alguns modulos";
...
$string['license_type'] = "Tipo de licença";
...
$string['local'] = "Course:";
$string['details'] = "Mostrar detalhes";

$string['eco_conf'] = "Configuracoes ECO";
$string['date_course_ends'] = "Data de final do curso:";
$string['student_effort'] = "Horas de trabalho do estudante:";
$string['imooc_course_url'] = "URL do curso iMOOC:";
