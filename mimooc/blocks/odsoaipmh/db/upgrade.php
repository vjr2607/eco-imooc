...
function xmldb_block_odsoaipmh_upgrade($oldversion) {
	...
	$table->add_field('startdate', XMLDB_TYPE_TEXT, null, null, XMLDB_NOTNULL, null, null);
	$table->add_field('n_units', XMLDB_TYPE_INTEGER, null, null, XMLDB_NOTNULL, null, null);
        ...
        $table->add_field('taxonomy_id', XMLDB_TYPE_TEXT, null, null, XMLDB_NOTNULL, null, null);
        $table->add_field('taxonomy', XMLDB_TYPE_TEXT, null, null, XMLDB_NOTNULL, null, null);
	$table->add_field('teachers', XMLDB_TYPE_TEXT, null, null, XMLDB_NOTNULL, null, null);
	$table->add_field('enddate', XMLDB_TYPE_TEXT, null, null, XMLDB_NOTNULL, null, null);
	$table->add_field('effort', XMLDB_TYPE_INTEGER, null, null, XMLDB_NOTNULL, null, null);
	$table->add_field('course_url', XMLDB_TYPE_TEXT, null, null, XMLDB_NOTNULL, null, null);
