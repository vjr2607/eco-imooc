...
class block_odsoaipmh_edit_form extends block_edit_form {
	...
	$mform->addElement('header', 'configheader', get_string('eco_conf', $_CFG_MODULE_OAIPMH->block_modulename));
	$mform->addElement('text', 'config_c_effort', get_string('student_effort', $_CFG_MODULE_OAIPMH->block_modulename));
	$mform->setDefault('config_c_effort', 10);
	$mform->setType('config_c_effort', PARAM_INT);
	$mform->addElement('text', 'config_c_courseurl', get_string('imooc_course_url', $_CFG_MODULE_OAIPMH->block_modulename));
	$mform->setDefault('config_c_courseurl', 'http://imooc.uab.pt');
	$mform->setType('config_c_courseurl', PARAM_TEXT);
	$mform->addElement('date_time_selector', 'config_c_enddate', get_string('date_course_ends', $_CFG_MODULE_OAIPMH->block_modulename));
	$mform->setType('config_c_enddate', PARAM_TEXT);
