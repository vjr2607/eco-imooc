...
$data = "body {background: $et_bkimg; font-family: \"Trebuchet MS\",Arial,Tahoma,Verdana,sans-serif; }// vjr}
...
#login-dropdown a.elgg-button-dropdown {
        border-radius: 0;
        font-weight: normal;
        font-size: 12px;
