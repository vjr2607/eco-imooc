...
function expages_init() {
	...
	// vjr elgg_register_page_handler('terms', 'expages_page_handler');
	// vjr elgg_register_page_handler('privacy', 'expages_page_handler');
	// vjr elgg_register_page_handler('expages', 'expages_page_handler');
...
function expages_public($hook, $handler, $return, $params){
	$pages = array('about'); //vjr , 'terms', 'privacy');
