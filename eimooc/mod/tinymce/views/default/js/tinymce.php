...
elgg.tinymce.init = function() {
	...
	tinyMCE.init({
		...
		plugins : "lists,spellchecker,autosave,fullscreen,paste,media,emotions",
		relative_urls : false,
		...
		theme_advanced_buttons2 : "justifyleft,justifycenter,justifyright,justifyfull,media,emotions,forecolor,backcolor",
