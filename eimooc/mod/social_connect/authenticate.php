...
?>
		...
		<script>
			function init() {
				//vjr window.opener.location.reload();
				//window.opener.location = "<?php echo 'http://eco.imooc.uab.pt/elgg/pg/blti_consumer/launch?guid=17707';?>"; //vjr
//				window.open("http://eco.imooc.uab.pt/elgg/pg/blti_consumer/launch?guid=50629", "_top");
				window.open("http://eco.imooc.uab.pt/elgg/elenco_cursos", "_top");
				//window.close();
			}
		</script>
		</head>
